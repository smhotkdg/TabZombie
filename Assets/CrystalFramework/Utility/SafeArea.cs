...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        void ApplySafeArea (Rect r)
        {
            ...
            //virtualCamera.m_Lens.OrthographicSize = ((((float)Screen.height)/((float)Screen.width/1f))/ 2f) + Margin;
            float currentAspect = (float)Screen.width / (float)Screen.height;
            virtualCamera.m_Lens.OrthographicSize = horizontalResolution / currentAspect / Margin;
        }
    }
}
