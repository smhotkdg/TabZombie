...
public class PlayNANOOExample : MonoBehaviour, IChatListener, IPlayNANOOServiceListener
{
    Plugin plugin;
    ...
    void Start()
    {
        ...
        plugin.SetServiceListener(this);
    ...
    public void OnAccountFailed(string errorCode, string errorMessage)
    {
    ...
    public void GameLog()
    {
        ...
        logParams.Add("Level1", "1100");
        logParams.Add("Level2", "2100");
        logParams.Add("Level3", "3100");
        logParams.Add("Level4", "4100");

        plugin.GameLog.Save("TABLE_CODE", logParams, (state, message, jsonString, dictionary) => {
