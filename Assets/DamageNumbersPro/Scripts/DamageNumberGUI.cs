...
namespace DamageNumbersPro
{
    ...
    {
        public delegate void GetNumber(int maxNumber,GameObject numberObject);
        public event GetNumber GetNumberEventHandler;

        public delegate void Stop();
        public event Stop StopEventRoutine;
        /* 
        ...
        {
            GetNumberEventHandler?.Invoke((int)newSum,this.gameObject);
        }
